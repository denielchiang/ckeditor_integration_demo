defmodule CkeditorIntegrationDemo.ContentTest do
  use CkeditorIntegrationDemo.DataCase

  alias CkeditorIntegrationDemo.Content

  describe "posts" do
    alias CkeditorIntegrationDemo.Content.Post
